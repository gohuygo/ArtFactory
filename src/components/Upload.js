...
const FileLabel= styled.label`
  &:after {
    background-color: #D3959B !important;
  }
`
      ...
      <h2>Upload to ArtFactory</h2>
        ...
        <div className="input-group mb-3">
				  <div className="custom-file">
				    ...
				    <FileLabel className="custom-file-label" id="upload-label" htmlFor="inputGroupFile02" aria-describedby="inputGroupFileAddon02">Choose file</FileLabel>
				  </div>
				</div>
